...
export default function DriverAttendancePage() {
  ...
  // Mock attendance data for driver - replace with actual API call
  const attendanceData: Record<number, { status: "present" | "absent" | "leave"; clockIn?: string; clockOut?: string }> = {
    1: { status: "present", clockIn: "08:45 AM", clockOut: "06:30 PM" },
    2: { status: "present", clockIn: "09:00 AM", clockOut: "05:45 PM" },
    3: { status: "leave" },
    5: { status: "present", clockIn: "08:30 AM", clockOut: "06:00 PM" },
    10: { status: "present", clockIn: "08:50 AM", clockOut: "06:15 PM" },
    15: { status: "present", clockIn: "08:40 AM", clockOut: "06:20 PM" },
  };
    ...
    <DashboardLayout>
      <div className="p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-400">View your attendance records and clock in/out</p>
        </div>
