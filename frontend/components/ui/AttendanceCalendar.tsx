...
const AttendanceCalendar = ({ 
    ...
    return (
        <div className={cn("p-3 w-full border-[0.5px] rounded-xl bg-white dark:bg-gray-900 shadow-sm", className)}>
                ...
                {calendarDays.map((day) => {
                    ...
                    return (
                        <button
                            ...
                            className={cn(
                                "h-24 w-full p-1.5 font-normal text-base flex flex-col items-center justify-center transition-colors relative border-r border-b border-gray-200 dark:border-gray-800",
                                ...
                                holiday && !isSelected && "bg-amber-50 dark:bg-amber-900/20",
                            )}
