            ...
            <main className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto p-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm">
                                ...
                                <div className="h-[220px] w-full mt-4">
                                    ...
                                    <div className="flex justify-between mt-4">
                                        <span className="text-[11px] font-bold text-[#49659c] uppercase">Mon</span>
                                        <span className="text-[11px] font-bold text-[#49659c] uppercase">Tue</span>
                                        <span className="text-[11px] font-bold text-[#49659c] uppercase">Wed</span>
                                        <span className="text-[11px] font-bold text-[#49659c] uppercase">Thu</span>
                                        <span className="text-[11px] font-bold text-[#49659c] uppercase">Fri</span>
                                        <span className="text-[11px] font-bold text-[#49659c] uppercase">Sat</span>
                                        <span className="text-[11px] font-bold text-[#49659c] uppercase">Sun</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm">
                                ...
                                <div className="grid grid-cols-6 items-end gap-4 h-[180px] px-2">
                                    {['JAN', 'FEB', 'MAR', 'APR', 'MAY', 'JUN'].map((m, i) => {
                                        ...
                                        return (
                                            <div key={m} className="relative group flex flex-col items-center">
                                                <div className={`w-full ${heights[i]} rounded-t-lg transition-colors cursor-pointer ${isActive ? 'bg-[#0d59f2]' : 'bg-[#0d59f2]/20 hover:bg-[#0d59f2]'}`} />
                        ...
                        {/* Right Column: Financial Overview and Recent Activities */}
                            ...
                            <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden flex flex-col">
                                <div className="p-6 flex-1">
                                    <div className="flex items-center gap-2 text-[#0d59f2] mb-4">
                                        <Wallet size={16} />
                                        <p className="text-xs font-bold uppercase tracking-widest">Financial Overview</p>
                                    </div>
                                    ...
                                    <button className="w-full py-2.5 bg-[#0d59f2] text-white rounded-lg text-sm font-bold hover:bg-[#0d59f2]/90 transition-all flex items-center justify-center gap-2 group">
